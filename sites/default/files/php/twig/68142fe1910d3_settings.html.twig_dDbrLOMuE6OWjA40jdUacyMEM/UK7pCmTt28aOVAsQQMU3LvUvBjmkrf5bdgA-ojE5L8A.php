...
class __TwigTemplate_e59353955121602ec47a32e2fe81b960 extends Template
{
...
";
    ...
    {
        return new Source("{% if fontawesome_five %}
  {{ attach_library('kart/fontawesome5') }}
{% endif %}
{% if fontawesome_six %}
  {{ attach_library('kart/fontawesome6') }}
{% endif %}
{% if bootstrapicons %}
  {{ attach_library('kart/bootstrap-icons') }}
{% endif %}
...
", "@kart/parts/settings.html.twig", "/var/www/html/themes/contrib/kart/templates/parts/settings.html.twig");
    }
